...
export default function Address() {
  ...
  const actionApiUrl = 'https://blinks-workshop-git-main-kimerrans-projects.vercel.app/api/actions/transfer-sol';
      ...
      {publicKey ? (
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            {actionResponse ? <Blink action={actionResponse} websiteText={new URL(actionApiUrl).hostname} /> : null}
